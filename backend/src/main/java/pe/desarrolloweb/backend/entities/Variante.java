...
public class Variante {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "variante_seq_gen")
    @SequenceGenerator(name = "variante_seq_gen", sequenceName = "variante_seq", allocationSize = 1)
    private Long id;
